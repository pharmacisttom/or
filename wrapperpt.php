    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h3 class="m-0 font-weight-bold text-primary">รายชื่อผู้ป่วยที่รับบริการห้องผ่าตัด</h3>
            </div>
            ...
            <a href="./pt6.php" type="button" class="btn btn-danger">คนไข้นัดผ่าตัด</a>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $sql6 = "select * from patients order by id desc";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $pp_labels = [
                                            ...
                                            "5" => "<b style='color:gray'>นัดผ่าตัด</b>",
                                        ];
