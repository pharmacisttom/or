...
// ดึงข้อมูลผู้ป่วย
$sql = "SELECT DISTINCT a.hn,a.an,b.fullname,b.yage,b.weight,b.high,b.sign,b.cardid
FROM ipd.ipd a
LEFT JOIN opd.opd b on a.hn = b.hn and a.regdate = b.regdate
where a.regdate BETWEEN 20241001 and date(now()) and a.hn = ?";
